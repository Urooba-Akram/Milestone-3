...
export default function Feature(){
    return (
        ...
        <p className='text-center m-4 mt-4 text-sm text-black sm:text-base md:mb-12 lg:mb-16 animate-fade-in-up delay-100'>
            ...
            development. From foundationtional concepts to advanced techniques, this
...
{[
    ...
    <div key={index}
    className='relative group p-6 bg-white rounded-lg shadow-lg hover:bg-sky-400 hover:text-lack transition duration-300 ease-in-out transform hover: scale-105 cursor-pointer flex items-center justify-center text-neutral-600'>
...
Dive into our diverse range of categories, where you'll discover a wealth f knowledge 
and insights tailored to your interests.Each category features carefully curated blogs that
explore the latest trends, innvative technologies, and essential skills in the world of Web
development and beyond. Whether you're a budding dveloper, an experienced Tech
